...
const Footer = () => {
    return (
        <div className="bg-[#f04d4d] text-white mt-20">
            <div className="flex lg:justify-between justify-center gap-10 lg:flex-row flex-col py-5 w-11/12 lg:w-3/4 mx-auto text-lg">
                <Link href="/"><p className="text-3xl font-semibold">Blood Link</p></Link>
                <aside>
