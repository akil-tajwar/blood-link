    ...
    return (
        <div className='bg-[url(banner.jpg)] bg-cover bg-center text-center'>
            <div className='lg:py-80 py-52 h-full lg:w-full w-11/12 mx-auto'>
                <h1 className='lg:text-6xl text-4xl font-semibold text-[#df1f21]'>Donate Blood</h1>
                ...
                <button className='bg-[#df1f21] font-semibold text-white mt-5 px-4 pt-1 pb-2 lg:text-2xl text-lg rounded-full'>Donate Now</button>
            </div>
        </div>
    );
};
